...
public class Practice05ComposeShaderView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Shader shadeBitmap = new BitmapShader(bitmapBatman, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        Shader shaderLog = new BitmapShader(bitmapLOgo, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);

        ComposeShader composeShader = new ComposeShader(shadeBitmap, shaderLog, PorterDuff.Mode.SRC_OVER);
